...
export default class ListView extends View
{
    metadata = {
        properties: {
            ...
            $itemTemplates: { type: "object", defaultValue: [] },
            countItems: { type: "int", defaultValue: 0 }
        }
    };
    ...
    get countItems()
    {
        return this.getProperty("countItems");
    }
    set countItems(value)
    {
        this.setProperty("countItems", value);
    }
    ...
    selectItem(item = null)
    {
        ...
        {
            this.$getItem(this.getProperty("selection")).removeClass("selected");
    ...
    $createItem(type = 0)
    {
        if (!this.getProperty("$itemTemplates")[type]) {
            this.getProperty("$itemTemplates")[type] = this.$createNewItem(type);
        }
        return this.getProperty("$itemTemplates")[type].clone();//可以大大提高效率
    }
